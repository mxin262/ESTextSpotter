...
model_config_path = "config/ESTS/ESTS_4scale_mlt_finetune.py" # change the path of the model config file
model_checkpoint_path = "checkpoint0100.pth" # change the path of the model checkpoint
...
image_dir = 'data/totaltext/test_images/'
